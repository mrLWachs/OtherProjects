...
{
    /// <summary>
    /// MrWachs - represents a Mr Wachs computer science teacher person
    /// </summary>
    class MrWachs : ComputerScienceTeacher
    {

        /// <summary>
        /// Default constructor for the class, sets class properties
        /// </summary>
        public MrWachs(string name, int age, 

    ...
    class Pacman : LivingGameObject
    {
        ...
        public void animate()
        {
            ...
            if (isOpen == true)
            {
                ...
                hitbox.Image = Properties.Resources.pacmanResting;
                isOpen = false;
            }
            else if (isOpen == false)
            {
                ...
                if      (direction == MOVE_LEFT)  hitbox.Image = Properties.Resources.pacmanLeft;
                else if (direction == MOVE_RIGHT) hitbox.Image = Properties.Resources.pacmanRight;
                else if (direction == MOVE_UP)    hitbox.Image = Properties.Resources.pacmanUp;
                else if (direction == MOVE_DOWN)  hitbox.Image = Properties.Resources.pacmanDown;
                isOpen = true;
            }
        }
    }

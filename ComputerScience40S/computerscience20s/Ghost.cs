...
//using ComputerScience40S.Properties;
using System;
    ...
    class Ghost : LivingGameObject
    {
        ...
        public void animate()
        {
            ...
            if (isOpen == true)
            {
                ...
                if      (ghostType == PacmanGlobals.BLINKY) hitbox.Image = Properties.Resources.BlinkyClosed;
                else if (ghostType == PacmanGlobals.INKY)   hitbox.Image = Properties.Resources.InkyClosed;
                else if (ghostType == PacmanGlobals.PINKY)  hitbox.Image = Properties.Resources.PinkyClosed;
                else if (ghostType == PacmanGlobals.CLYDE)  hitbox.Image = Properties.Resources.ClydeClosed;
                isOpen = false;
            }
            else if (isOpen == false)
            {
                ...
                // change the image and set the flag to closed
                if      (ghostType == PacmanGlobals.BLINKY) hitbox.Image = Properties.Resources.BlinkyOpen;
                else if (ghostType == PacmanGlobals.INKY)   hitbox.Image = Properties.Resources.InkyOpen;
                else if (ghostType == PacmanGlobals.PINKY)  hitbox.Image = Properties.Resources.PinkyOpen;
                else if (ghostType == PacmanGlobals.CLYDE)  hitbox.Image = Properties.Resources.ClydeOpen;
                isOpen = true;
            }
        }
